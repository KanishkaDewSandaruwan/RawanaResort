                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <h1 style="color: #050c2a; text-align: center;"><b>Rawana Hotel - Create Password</b></h1>
                                    <form action="" method="post">
                                        ...
                                        <button type="button" onclick="addCustomerPassword(this.form)"
                                            class="btn btn-primary py-3 w-100 mb-4">Create Password</button>
